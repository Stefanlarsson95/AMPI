...
python /home/pi/Documents/Python/AMPI/hardware/pushconfig.py /home/pi/Documents/Python/AMPI/SigmaStudio/TxBuffer_IC_1.dat
echo "Starting SigmaTCP server"
/home/pi/Documents/Python/AMPI/sigma_tcp/sigma_tcp i2c /dev/i2c-1 0x34 &
sleep 1
