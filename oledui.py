...
font = load_font('Roboto-Regular.ttf', 28)#24
...
def SetState(status):
    ...
    if oled.state == STATE_PLAYER:
        oled.modal = NowPlayingScreen(oled.HEIGHT, oled.WIDTH, oled.activeArtist, oled.activeSong, font, font2, hugefontaw, oled.ptime, oled.duration)
...
class NowPlayingScreen():
    def __init__(self, height, width, row1, row2, font, font2, fontaw, ptime, duraton):
        self.height = height
        self.width = width
        self.font = font
        self.fontaw = fontaw
